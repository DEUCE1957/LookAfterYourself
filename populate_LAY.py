    ...
    Posts = [
        ...
        },
        {
            ...
            "content":  "As much as I would love to be one of those people who jumps out of bed in the mornings, wide eyed, refreshed and ready to take on the day ahead, it just isn’t me. " \
                        ...
                        "of my blankets. But I have found something that helps. I call it the “one hour rule.” Within one hour of waking up, I have to be out of my bed. If I look at the clock when " \
                        ...
                        "But I make myself try. Try to taste the day. I don’t have to like it, I just have to do it. I have to be up though. I have to be doing or moving or creating. " \
                        "It can work like a domino effect. If I am up, I may as well take a shower, may as well make some breakfast, and hey — seeing as I’m already up, I might just leave the " \
                        "house today. I can’t promise that it always works like this, but one thing I do know is that I always feel better for giving it a go. I encourage you to give yourself one " \
                        "hour, 60 minutes, 3,600 seconds. It might suck, and you may get out of your bed just to end up on the floor instead, or sitting on the landing, or you might make it to sit on " \
                        "the shower floor. But at least you tried. You got up and you gave today a chance. You did the absolute best that you could, and there is no shame in that. It does not go " \
                        "unnoticed. (credit: https://themighty.com/2017/05/one-hour-rule-mental-illness-getting-out-of-bed/",
        },
